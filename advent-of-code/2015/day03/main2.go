...
func (santa *Santa) right() {
	coord := santa.coord
	santa.coord = cod{coord.x + 1, coord.y}
}
...
func (santa *Santa) up() {
	coord := santa.coord
	santa.coord = cod{coord.x, coord.y - 1}
}
...
func (santa *Santa) deliver(homes map[cod]bool) {
